...
| 阶段 | 文档 | 状态 |
|---|---|---|
| **Phase B** | [11 - Phase B 种子导入器实现指南](./11-Phase-B-种子导入器实现指南.md) | 🚧 待实现（用户自己写 Java） |
| **Phase C** | [12 - Phase C 推荐特征计算实现指南](./12-Phase-C-推荐特征计算实现指南.md) | 📋 已设计 |
| 后续 | [20 - 后续路线图](./20-后续路线图.md) | 📋 已规划 |
